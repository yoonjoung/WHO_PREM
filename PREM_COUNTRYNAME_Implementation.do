...
do PREM_COUNTRYNAME_DataManagement.do
...
***** C.2. Create process metrics at the client level
	...
	*Number of clients/respondents
		...
		*Number of respondents who completed more than 50% of the interview*
		gen num_comp50 = 1 if q001==1 & (xcomplete==1 | (q302==3 & pq_missing>0.5 & pq_missing!=. ))
...
export excel using "$chartbookdir/PREM_COUNTRYNAME_Chartbook.xlsx", sheet("Pilot_Implementation") sheetreplace firstrow(variables) nolabel keepcellfmt
