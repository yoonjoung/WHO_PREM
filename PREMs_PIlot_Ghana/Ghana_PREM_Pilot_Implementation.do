...
do Ghana_PREM_Pilot_DataManagement_WORKING.do
...
export excel using "$chartbookdir/Ghana_PREM_Pilot_Chartbook_WORKING.xlsx", sheet("Pilot_Implementation") sheetreplace firstrow(variables) nolabel keepcellfmt
