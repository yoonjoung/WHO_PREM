...
export excel using "$chartbookdir/Ghana_PREM_Pilot_Chartbook_WORKING.xlsx", sheet("Client_raw_data") sheetreplace firstrow(variables) nolabel
...
*****E.2. Export clean facility-level data to chart book 
	...
	export excel using "$chartbookdir/Ghana_PREM_Pilot_Chartbook_WORKING.xlsx", sheet("Client_clean_data") sheetreplace firstrow(variables) nolabel
...
export excel using "$chartbookdir/Ghana_PREM_Pilot_Chartbook_WORKING.xlsx", sheet("PREMs_estimates") sheetreplace firstrow(variables) nolabel keepcellfmt
