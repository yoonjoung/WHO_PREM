...
***** E.1 Drop data that were entered before the RESTART 
		...
		------------+-----------------------------------
		  27nov2023 |          6        0.64        0.64
		  06dec2023 |          7        0.75        1.39
		  07dec2023 |         61        6.55        7.94
		  08dec2023 |        233       25.00       32.94
		  09dec2023 |        192       20.60       53.54
		  10dec2023 |         79        8.48       62.02
		  11dec2023 |         77        8.26       70.28
		  12dec2023 |        133       14.27       84.55
		  13dec2023 |         79        8.48       93.03
		  14dec2023 |         48        5.15       98.18
		  20dec2023 |         17        1.82      100.00
		------------+-----------------------------------
			  Total |        932      100.00
	...
	*gen byte temp = listingdatetime < clock("`REstartdatetime'", "YMD hms")
		tab listingdate temp, m

	drop if listingdate < date("`REstartdate'","YMD") 
	*drop if listingdatetime < clock("`REstartdatetime'", "YMD hms")
