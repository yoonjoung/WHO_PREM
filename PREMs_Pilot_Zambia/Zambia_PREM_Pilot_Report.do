...
do Zambia_PREM_Pilot_Implementation.do
...
putdocx text (""),  
			...
			return list 
putdocx text ("Total number interviewed in English: `r(mean)'"), linebreak

			sum num_comp if grouplabel=="`countrylanguage1'_Phone_All"
			return list 
putdocx text ("Total number interviewed in `countrylanguage1': `r(mean)'"), linebreak
...
putdocx image "temp.png", height(3) width(6)	
		...
		graph hbar ///
			...
			legend( 
				...
				label(4 "No answer/" "switched off")
...
preserve
		...
		#delimit;
		graph twoway line num_compcumPhone_English num_compcumPhone_`countrylanguage1' date , 
			title("")
			note("Preliminary results for internal review. Update  as of: $date", size(vsmall)) 
...
putdocx image "temp.png", height(3) width(6)		
		...
		#delimit;
		graph twoway line num_callcumPhone_English num_callcumPhone_`countrylanguage1'  date , 
			title("")
			note("Preliminary results for internal review. Update  as of: $date", size(vsmall)) 
			ytitle("Cumulative number") 		
			legend( 
